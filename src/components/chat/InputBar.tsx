...
export function InputBar() {
  ...
  // Images from the native paste event. When the clipboard holds an image,
  // the main process uses webContents.paste() so the DOM event fires here.
  // Text-only clipboards are routed through the IPC paste:text channel (see
  // App.tsx) to work around role:'paste' missing input events on controlled
  // textareas.
